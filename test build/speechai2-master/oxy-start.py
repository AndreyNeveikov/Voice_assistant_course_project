...
class W(QMainWindow):
    ...
    def myvopros(self, data):
        ...
        if vp == 'пока' or vp == 'выход' or vp == 'выйти' or vp == 'до свидания':
            ...
            ot = Assistant_functions.anekdot()
        elif 'запусти' in vp:
            ot = Assistant_functions.zapusti(vp)
            ...
            zapros = Assistant_functions.cleanphrase(vp, ['найти', 'найди', 'про', 'про то', 'о том'])
            q = Assistant_functions.mysearch(zapros)
